...
public class CookieUtil {
    ...
    public static void addCookie(HttpServletResponse response,String name,String value,int seconds){
        ...
        cookie.setMaxAge(seconds);// 设置为30min
        cookie.setPath("/");
     ...
     */
    public static void editCookie(HttpServletRequest request,HttpServletResponse response,String name,String value,int seconds){
